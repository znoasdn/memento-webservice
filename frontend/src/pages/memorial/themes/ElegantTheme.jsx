//frontend/src/pages/memorial/themes/ElegantTheme.jsx 우아한

export default function ElegantTheme({ data }) {
  const { space, photos, guestbook } = data;

  const colors = {
  primary: '#F4F3EF',      // 부드러운 아이보리
  secondary: '#1C2740',    // 깊은 네이비
  accent: '#D8C27A',       // 고급 골드 포인트
  text: '#1F2937',         // 딥그레이 텍스트
  border: '#C8B98C'        // 골드 톤 테두리
};
